        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto font-light leading-relaxed">
              Find answers to common questions about CyberSquad, our features,
              security, and how to make the most of our platform.
            </p>
          </div>
                  ...
                  {category.questions.map((item, index) => {
                    ...
                    return (
                      <div key={itemIndex} className="group relative">
                        <div
                          className={`absolute -inset-0.5 bg-gradient-to-r from-purple-500 to-blue-500 rounded-2xl opacity-0 ${isOpen ? "opacity-50" : "group-hover:opacity-50"} transition-all duration-300 blur-lg`}
                        ></div>
                        <Card
                        ...
                        >
                          <CardContent className="p-6">
                            <div className="flex items-center justify-between gap-4">
                              <h3 className="text-lg font-bold text-white flex-1 text-left">
                                {item.q}
                              </h3>
                              <ChevronDown
