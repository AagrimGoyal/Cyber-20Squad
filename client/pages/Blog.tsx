  ...
  const articles = [
    {
      ...
      excerpt: "Learn the telltale signs of phishing attacks and protect yourself from email-based fraud.",
      category: "Security",
      author: "Sarah Chen",
      date: "Mar 15, 2025",
      readTime: "8 min read",
      color: "from-red-500 to-pink-600",
      image: "https://images.unsplash.com/photo-1563986768609-322da13e493e?w=500&h=300&fit=crop",
    },
    {
      id: 2,
      title: "Building Your First Emergency Fund: 5 Steps",
      excerpt: "Discover how to create a financial safety net that protects you during unexpected situations.",
      category: "Finance",
      author: "Michael Rodriguez",
      date: "Mar 12, 2025",
      readTime: "10 min read",
      color: "from-emerald-500 to-teal-600",
      image: "https://images.unsplash.com/photo-1579621970563-430f63602d4b?w=500&h=300&fit=crop",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      excerpt: "Deep dive into credit scoring systems and actionable strategies to boost your credit health.",
      category: "Finance",
      author: "Emma Watson",
      date: "Mar 8, 2025",
    ...
    },
    {
      ...
      excerpt: "Learn the risks of public Wi-Fi and techniques to protect your data while on-the-go.",
      category: "Security",
      author: "James Wilson",
      date: "Mar 5, 2025",
      readTime: "7 min read",
    ...
    },
    {
      ...
      excerpt: "A beginner-friendly guide to understanding stocks, bonds, and building a diversified portfolio.",
      category: "Finance",
      author: "Lisa Thompson",
      date: "Mar 1, 2025",
      readTime: "15 min read",
      color: "from-blue-500 to-cyan-600",
      image: "https://images.unsplash.com/photo-1518644730709-0835105d9dda?w=500&h=300&fit=crop",
    },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-10 font-light leading-relaxed">
              Expert insights on cybersecurity and financial literacy to help you stay informed and protected.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {filteredArticles.map((article) => (
              <div key={article.id} className="group relative">
                <div className={`absolute -inset-0.5 bg-gradient-to-r ${article.color} rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 blur-lg`}></div>
                <Card className="relative border-2 border-gray-700 bg-gray-900 overflow-hidden hover:shadow-2xl transition-all h-full flex flex-col">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    />
                    <Badge className={`absolute top-4 left-4 bg-gradient-to-r ${article.color} text-white border-none`}>
                      {article.category}
                    </Badge>
                  </div>
                  ...
                  <CardContent className="flex-1 flex flex-col p-6">
                    ...
                    <div className="space-y-3 pt-6 border-t border-gray-700">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs text-purple-400 font-semibold">{article.readTime}</span>
                      </div>
                    </div>
            ...
            <Card className="relative border-2 border-gray-700 bg-gradient-to-br from-gray-900 to-gray-950 overflow-hidden">
              <CardContent className="p-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  <div>
                    <Badge className="mb-4 bg-purple-600/30 text-purple-300 border border-purple-500/50">Featured</Badge>
                    <h3 className="text-4xl font-black text-white mb-6">
                      Deep Dive: Cybersecurity in Your Pocket
                    </h3>
                    <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                      Learn how to secure your mobile devices against threats, protect your personal data, and maintain digital hygiene on the go.
                    </p>
